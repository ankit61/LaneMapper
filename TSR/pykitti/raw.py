...
class raw:
    ...
    def _load_calib_cam_to_cam(self, velo_to_cam_file, cam_to_cam_file):
        ...
        #add distortion vectors
        data['D_cam0'] = filedata['D_00']
        data['D_cam1'] = filedata['D_01']
        data['D_cam2'] = filedata['D_02']
        data['D_cam3'] = filedata['D_03']

        #add sizes
        data['S_cam0'] = filedata['S_00']
        data['S_cam1'] = filedata['S_01']
        data['S_cam2'] = filedata['S_02']
        data['S_cam3'] = filedata['S_03']

        #add rotation matrices before rectification
        data['R_cam0'] = np.reshape(filedata['R_00'], (3, 3))
        data['R_cam1'] = np.reshape(filedata['R_01'], (3, 3))
        data['R_cam2'] = np.reshape(filedata['R_02'], (3, 3))
        data['R_cam3'] = np.reshape(filedata['R_03'], (3, 3))

        #add translation vectors 
        data['T_cam0'] = filedata['T_00']
        data['T_cam1'] = filedata['T_01']
        data['T_cam2'] = filedata['T_02']
        data['T_cam3'] = filedata['T_03']
