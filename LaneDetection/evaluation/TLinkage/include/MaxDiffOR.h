...
namespace LD {
	...
	class MaxDiffOR : public OutlierRejector {
		public:
			virtual void operator()(const ArrayXf& _clusters, const std::unordered_map<int, vector<ulli> >& _clusterID2PtIndices, ArrayXf& _out, const int& _noiseIndex = -1) override;
